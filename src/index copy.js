...
export {
  FirebaseApp, getFirebaseApp, User, Doc, Collection,
  /**
* @deprecated Use 'initUserStore' to provide configuration the use the 'user' store directly
*/
  userStore, initUserStore, user, updateProfile, docStore, collectionStore, fileDownloadStore, uploadTaskStore, StorageRef, UploadTask
}
